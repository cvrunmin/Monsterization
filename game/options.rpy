...
define config.name = _("Monsterization")
...
define build.name = "Monsterization"
...
#define config.automatic_images_strip = ['images','character','bg']
...
define config.save_directory = "Monsterization-1545219843"
